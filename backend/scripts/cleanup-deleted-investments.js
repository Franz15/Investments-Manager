...
async function cleanupDeletedInvestments() {
  try {
    ...
    console.log(`\n${"=".repeat(80)}`);
    console.log(
      `LIMPIEZA DE REGISTROS DE INVERSIONES ELIMINADAS PARA: ${userId}`,
    );
    ...
    console.log(
      `✅ Eliminados ${deletedVariationsResult.deletedCount} registros de DailyVariation de inversiones eliminadas`,
    );
