...
async function compareBalanceCalculations() {
  try {
    ...
    // Total según /stats
    const totalBalanceStats = totalCashSavings + totalInvestmentSubAccountBalance + totalInvestments;
    console.log(`\n✅ BALANCE TOTAL (/stats): ${totalBalanceStats.toFixed(2)}€`);
    console.log(`   = Cash/Savings (${totalCashSavings.toFixed(2)}) + Investment SubAccounts (${totalInvestmentSubAccountBalance.toFixed(2)}) + Investments (${totalInvestments.toFixed(2)})`);
    ...
    const balanceDaily = lastDayCash + totalInvestmentSubAccountBalance + lastDayInvestments - currentTotalDebts;
    console.log(`\n❌ BALANCE TOTAL (/balance-daily): ${balanceDaily.toFixed(2)}€`);
    console.log(`   = Cash (${lastDayCash.toFixed(2)}) + Investment SubAccounts (${totalInvestmentSubAccountBalance.toFixed(2)}) + Investments (${lastDayInvestments.toFixed(2)}) - Deudas (${currentTotalDebts.toFixed(2)})`);
    ...
    console.log(`  - Cash: ${totalCashSavings.toFixed(2)} vs ${lastDayCash.toFixed(2)} = ${(totalCashSavings - lastDayCash).toFixed(2)}€`);
    console.log(`  - Investment SubAccounts: ${totalInvestmentSubAccountBalance.toFixed(2)} vs ${totalInvestmentSubAccountBalance.toFixed(2)} = 0.00€`);
    console.log(`  - Investments: ${totalInvestments.toFixed(2)} vs ${lastDayInvestments.toFixed(2)} = ${(totalInvestments - lastDayInvestments).toFixed(2)}€`);
    console.log(`  - Deudas: 0.00 vs ${currentTotalDebts.toFixed(2)} = ${(-currentTotalDebts).toFixed(2)}€`);
