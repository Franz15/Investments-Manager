...
async function cleanupAllUsersDeletedInvestments() {
  try {
    ...
    console.log(`\n${"=".repeat(80)}`);
    console.log(
      `LIMPIEZA DE REGISTROS DE INVERSIONES ELIMINADAS PARA TODOS LOS USUARIOS`,
    );
    ...
    for (const userId of allUsers) {
      ...
      console.log(
        `  ✅ Eliminados ${deletedHistoryResult.deletedCount} registros de InvestmentHistory`,
      );
      ...
      console.log(
        `  ✅ Eliminados ${deletedVariationsResult.deletedCount} registros de DailyVariation`,
      );
