    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4 dark:bg-[#1d1d1f]">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded mb-4" style={{ backgroundColor: selectedUser?.color || '#3b82f6' }}>
        ...
        {!selectedUser ? (
            ...
            {users.map((user) => (
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.borderColor = isDark ? `${user.color}80` : `${user.color}40`;
                }}
                onMouseLeave={(e) => {
          ...
          <form onSubmit={handleLogin} className="card space-y-4">
            ...
            >
              {loading ? (
                <>
                  <div className="w-4 h-4 border-2 rounded-full animate-spin" style={{ borderColor: 'currentColor', borderTopColor: 'transparent', opacity: 0.8 }}></div>
