...
import { CgAdd, CgCreditCard, CgEditMarkup, CgTrash, CgChevronDown, CgChevronRight, CgTrending, CgChart, CgTrendingDown, CgTime, CgBot } from 'react-icons/cg';
                                          ...
                                          <div className="flex items-center justify-between">
                                            <div className="flex items-center flex-1">
                                              ...
                                              <div className="p-2 rounded-lg mr-3" style={{ backgroundColor: 'var(--user-color-100)', color: 'var(--user-color-600)' }}>
                                                {investment.isAutomatedPortfolio || investment.type === 'automated_portfolio' ? (
                                                  <CgBot className="h-4 w-4" style={{ color: 'var(--user-color-600)' }} />
